...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_bar_impl_ahci.sv"]\
 [file normalize "${origin_dir}/src/pcileech_tlps128_jitter_noise.sv"]\
 [file normalize "${origin_dir}/src/pcileech_tlps128_cfgspace_shadow.sv"]\
 [file normalize "${origin_dir}/src/pcileech_axis128_null.sv"]\
...
set file "src/pcileech_bar_impl_ahci.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "src/pcileech_tlps128_jitter_noise.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "src/pcileech_axis128_null.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
